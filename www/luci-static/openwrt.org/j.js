...
J_alert = function (content,title,submitstr,callback) {
	...
	oDiv.innerHTML = '<div style="overflow: hidden;background: #ddd;position: absolute;width: 80%;max-width: 500px;height: 200px;top: 0;bottom: 0;left: 0;right: 0;margin: auto;border: 1px solid #ccc;border-radius: 7px;box-shadow: 5px 5px 31px 0 #ccc;"><div style="background: #266783;height: 30px;color: #fff;"><span style="float: left;height: 20px;line-height: 20px;padding: 5px 10px;">' + title + '</span><span class="J_alert" style="float: right;height: 20px;line-height: 20px;padding: 5px 10px;cursor: pointer;">×</span></div><div style="height: 110px;padding: 5px 20px;">' + content + '</div><div style="height: 20px;padding: 5px 10px;text-align: center;"><button class="J_alert" style="margin: 0 60px;color:#266783;">' + submitstr + '</button></div></div>';
